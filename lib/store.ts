...
export type Business = { id:string; slug:string; name:string; rewardTarget:number; rewardText:string; logoUrl:string|null; stampUrl:string|null; cardTitle:string; cardSubtitle:string; primaryColor:string; stampShape:'circle'|'rounded'|'square'; active:boolean; createdAt:string; billingPlan:'trial'|'starter'|'professional'|'business'; subscriptionStatus:string; trialStartedAt:string|null; trialEndsAt:string|null; stripeCustomerId:string|null; stripeSubscriptionId:string|null; stripePriceId:string|null; subscriptionCurrentPeriodEnd:string|null; cancelAtPeriodEnd:boolean; billingGraceUntil:string|null; billingUpdatedAt:string|null };
