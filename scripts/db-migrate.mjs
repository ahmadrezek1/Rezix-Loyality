...
const migrations=['migrate-multitenant.sql','migrate-security-v04.sql','migrate-roles-v041.sql','migrate-gdpr-v05.sql','migrate-auth-v06.sql','migrate-billing-v07.sql','migrate-email-otp-v074.sql','migrate-loyalty-designer-v080.sql','migrate-email-only-auth-v084.sql','migrate-v100.sql','migrate-customer-design-v101.sql','migrate-manager-verification-v102.sql','migrate-pin-devices-v103.sql','migrate-trial-three-days-v104.sql','migrate-multibranch-v105.sql'];
try {
