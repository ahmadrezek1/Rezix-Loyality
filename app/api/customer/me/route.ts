...
export async function GET(req:Request){
 ...
 return NextResponse.json({customer:{name:c.name,code:c.code,stamps:c.stamps,rewardsRedeemed:c.rewards_redeemed,lastVisitAt:c.last_visit_at,hasPin:!!c.pin_hash},business:{id,slug,name,rewardTarget,rewardText,logoUrl,stampUrl,cardTitle,cardSubtitle,primaryColor,stampShape,customerDesign},operational:billingOperational(business)},{headers:{'Cache-Control':'no-store'}});
}
